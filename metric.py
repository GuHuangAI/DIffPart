...
sys.path.append('..')
from submodules import chamfer_3DDist  # chamfer_dist as chamfer
from submodules import EMD_Distance
...
def MMD_EMD_CD(sample_pcs, ref_pcs, batch_size, accelerated_cd=False, reduced=True):
    ...
    for b_start in tqdm(iterator, desc='EMD-CD'):
        ...
        emd_batch = EMD_Distance(sample_batch, ref_batch)
...
def _pairwise_EMD_CD_(sample_pcs, ref_pcs, batch_size,
    ...
    for sample_b_start in iterator:
        ...
        for ref_b_start in sub_iterator:
            ...
            emd_batch = EMD_Distance(sample_batch_exp, ref_batch)
...
if __name__ == '__main__':
    ...
    # metrics = compute_all_metrics(a, b, batch_size=8, accelerated_cd=True)
    # mmd = MMD_EMD_CD(a, b, batch_size=8)
    # cov = COV_MMD_CD(a, b)
    # print(mmd, cov)
    import open3d as o3d

    sample_shape_root = '/media/huang/T7/data/diff_nerf/sample_car/mesh/'
    ref_shape_root = '/media/huang/T7/data/ShapeNetCore_v1/02958343/'
    ref_render_root = '/media/huang/T7/data/diff_nerf/ShapeNet_v1_Part_Data/02958343/'
    sample_pcs = []
    ref_pcs = []
    ...
    for i in range(len(sample_shape_list)):
        sample_shape_path = os.path.join(sample_shape_root, sample_shape_list[i], 'original.obj')
        sample_mesh = o3d.io.read_triangle_mesh(sample_shape_path)
        sample_mesh.remove_unreferenced_vertices()
