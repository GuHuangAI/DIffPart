...
class Unet3D(nn.Module):
    def __init__(
        ...
        f_condnet = 512
        self.projects.append(nn.Linear(f_condnet, dims[0]))
        self.projects.append(nn.Linear(f_condnet, dims[1]))
        self.projects.append(nn.Linear(f_condnet, dims[2]))
        self.projects.append(nn.Linear(f_condnet, dims[3]))
    ...
    def forward(self, x, time, cond1=None, cond2=None, text=None, *args, **kwargs):
        bs = x.shape[0]
