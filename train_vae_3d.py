...
def main(args):
    ...
    #                         sample_num=data_cfg.get("sample_num", 5), cfg=data_cfg)
...
class Trainer(object):
    def __init__(
        ...
        self.model, self.opt_ae, self.opt_disc,  self.lr_scheduler_ae, self.lr_scheduler_disc, self.opt_nerf, self.lr_scheduler_nerf = \
            self.accelerator.prepare(self.model, self.opt_ae, self.opt_disc, self.lr_scheduler_ae,
                                     self.lr_scheduler_disc, self.opt_nerf, self.lr_scheduler_nerf)
